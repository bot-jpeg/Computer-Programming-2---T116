    ...
    while(1){
        ...
        switch(option){
            case 1:
                ...
                printf("C to Kelvin: %.2lf",finalValue);
                break;
            case 2:
                finalValue = convertTemp(initialValue,1,2);
                printf("C to Fahrenheit: %.2lf",finalValue);
                break;
            case 3:
                finalValue = convertTemp(initialValue,2,1);
                printf("K to Celsius: %.2lf",finalValue);
                break;
            case 4:
                finalValue = convertTemp(initialValue,2,2);
                printf("K to Fahrenheit: %.2lf",finalValue);
                break;
            case 5:
                finalValue = convertTemp(initialValue,3,1);
                printf("F to Celsius: %.2lf",finalValue);
                break;
            case 6:
                finalValue = convertTemp(initialValue,3,1);
                printf("F to Kelvin: %.2lf",finalValue);
                break;
